		...
		<Story>
			...
			>
				...
				<FormRow preset='middle'>
					<Text style={TEXT_STYLE_OVERRIDE}>
						...
						asperiores hic ex quae, quam dolores vel odit doloribus, tempore atque deserunt possimus incidunt,
						obcaecati numquam officiis.
					</Text>
				</FormRow>
				<FormRow preset='middle'>
			...
			<UseCase text='Alternatives' usage='Less commonly used presets.'>
				<FormRow preset='clear'>
					<Text style={TEXT_STYLE_OVERRIDE}>
						My borders are still there, but they are clear. This causes the text to still align properly due to
						the box model of flexbox.
					</Text>
				</FormRow>
